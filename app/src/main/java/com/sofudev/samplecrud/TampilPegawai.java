...
public class TampilPegawai extends AppCompatActivity implements View.OnClickListener {
    ...
    private void showEmployee(String json){
        Log.d(TampilPegawai.class.getSimpleName(), "Employee id : " + json);
        try {
            JSONObject jsonObject = new JSONObject(json);
            String name = jsonObject.getString(konfigurasi.COL_NAMA);
            String desg = jsonObject.getString(konfigurasi.COL_POSISI);
            String sal = jsonObject.getString(konfigurasi.COL_GAJIH);
